function [qopt] = InformationCriteria(w,qmin,qmax,type)
% Calculates optimal lag length using either AIC or BIC
% INPUTS:    w...              3xT matrix, Observations for which VAR(q) is fitted
...
% calculate AIC or BIC (note that they are based on Tnew, instead of T, residuals):
